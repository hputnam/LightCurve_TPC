...
blanks %>% ggplot(aes(x=as.numeric(Light_Value), y=micromol.s,colour = as.factor(Run)))+
  geom_point()

str(summary(lm(xx$micromol.s.blank~as.numeric(xx$Light_Value))))
anova(lm(xx$micromol.s.blank~as.numeric(xx$Light_Value)))
