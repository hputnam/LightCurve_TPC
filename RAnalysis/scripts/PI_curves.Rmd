...
## Import metadata
```{r, warning = FALSE}
path.p <- "data/1_pi_curves/1Run" #the location of all your respirometry files 
...
write.csv(pr, "output/pi_curve_extracted_rates_Run1.csv")
```
...
anova(lm(micromol.s.blank~as.numeric(Light_Value)*Run, data=blanks))
...
# Write to output file
write.csv(pr.out, "output/pi_curve_extracted_rates_Run3.csv")
```
